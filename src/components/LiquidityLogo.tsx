    ...
    <div className={`flex items-center gap-2.5 select-none ${className}`}>
      ...
      <div className="relative flex items-center justify-center shrink-0">
        ...
        >
          ...
          {/* Candlestick 1: Bullish Liquidity Sweep Bar (Green) */}
          ...
          {/* Candlestick 2: Inducement Wick & Displacement Bar (Red / Accent) */}
          ...
          {/* Candlestick 3: Institutional Expansion Bar (Dark/White) */}
